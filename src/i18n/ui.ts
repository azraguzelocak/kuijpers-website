...
export const languages = { en: "EN", nl: "NL", de: "DE", fr: "FR" } as const;
...
export const ui = {
	en: {
		...
		"home.press.eyebrow": "In the press",
		"home.press.title": "Where our work has been covered",
		"home.press.subtitle": "Journalists and trade media visiting the research field, and what they reported.",
		"home.press.read": "Read the article",
		"home.press.prev": "Previous articles",
		"home.press.next": "More articles",
		// home — innovations
		...
		"exp.pause": "Pause",
		"exp.spin": "Spin",
		"exp.empty.title": "Explore the web",
		"exp.empty.body": "Rotate the network below, or click a marker on the map above, to see what an innovation does, how it connects, and its impact.",
		"exp.impact.direct": "Estimated impact — green = saving, blue = extra use/discharge",
		"exp.impact.indirect": "Indirect innovation — its value flows through the innovations it connects to",
		"exp.readmore": "Read the full story →",
		"exp.connectedto": "Connected to:",
		"exp.howconnect": "How they connect",
		"exp.reset": "Reset",
		"exp.every": "Every innovation",
		"exp.direct": "Direct impact",
		"exp.indirect": "Indirect",
		"exp.filter.all": "All",
		"f3d.title": "Kuijpers farm · 3D model",
		"f3d.outside": "Outside",
		"f3d.inside": "Inside",
		"f3d.hint": "Drag to orbit · scroll to zoom",
		"f3d.hintTouch": "Drag to orbit · pinch to zoom",
		"f3d.loading": "Building model…",
		"f3d.fullscreen": "Full screen",
		"f3d.exit": "Exit",
		"f3d.pause": "Pause",
		"f3d.play": "Play",
		"f3d.failed": "3D failed to load — refresh the page",
		"f3d.aria.stage": "3D farm. Drag to orbit, scroll to zoom. Use Inside to enter the barn.",
		"f3d.aria.pause": "Pause rotation",
		"f3d.aria.play": "Play rotation",
		"innd.back": "← Back to all innovations",
		"innd.direct": "Direct impact",
		"innd.indirectinn": "Indirect innovation",
		"innd.whatitis": "What it is",
		"innd.howconnects": "How it connects",
		"innd.links": "No innovation stands alone. This one links to {n} others in the system.",
		"innd.requires": "Requires",
		"innd.strengthenedby": "Strengthened by",
		"innd.impact": "Impact",
		"innd.impact.direct": "Estimated per kg live weight and per year. Green = a saving, blue = extra use or discharge.",
		"innd.impact.indirect": "This is an indirect innovation — its value flows through the innovations it connects to, rather than a standalone figure.",
		"innd.exploremap": "Explore the full innovation map",
		"innd.footer": "Impact figures are indicative, based on {kg} kg live weight per year (256,000 places × 7 cycles), and will be replaced with measured data.",
		"about.cta.title": "Let's build something together",
		"about.cta.body": "Curious how digital twin technology could support your research, products or production? We'd love to hear from you.",
	...
	nl: {
		...
		"home.press.eyebrow": "In de media",
		"home.press.title": "Waar ons werk is besproken",
		"home.press.subtitle": "Journalisten en vakmedia die het research field bezochten, en wat zij schreven.",
		"home.press.read": "Lees het artikel",
		"home.press.prev": "Vorige artikelen",
		"home.press.next": "Meer artikelen",
		...
		"exp.pause": "Pauze",
		"exp.spin": "Draaien",
		"exp.empty.title": "Verken het web",
		"exp.empty.body": "Draai het netwerk hieronder, of klik op een markering op de kaart hierboven, om te zien wat een innovatie doet, hoe ze verbindt en wat haar impact is.",
		"exp.impact.direct": "Geschatte impact — groen = besparing, blauw = extra verbruik/lozing",
		"exp.impact.indirect": "Indirecte innovatie — haar waarde loopt via de innovaties waarmee ze verbonden is",
		"exp.readmore": "Lees het volledige verhaal →",
		"exp.connectedto": "Verbonden met:",
		"exp.howconnect": "Hoe ze verbinden",
		"exp.reset": "Herstel",
		"exp.every": "Elke innovatie",
		"exp.direct": "Directe impact",
		"exp.indirect": "Indirect",
		"exp.filter.all": "Alle",
		"f3d.title": "Kuijpers-boerderij · 3D-model",
		"f3d.outside": "Buiten",
		"f3d.inside": "Binnen",
		"f3d.hint": "Sleep om te draaien · scroll om te zoomen",
		"f3d.hintTouch": "Sleep om te draaien · knijp om te zoomen",
		"f3d.loading": "Model bouwen…",
		"f3d.fullscreen": "Volledig scherm",
		"f3d.exit": "Sluiten",
		"f3d.pause": "Pauze",
		"f3d.play": "Afspelen",
		"f3d.failed": "3D kon niet laden — vernieuw de pagina",
		"f3d.aria.stage": "3D-boerderij. Sleep om te draaien, scroll om te zoomen. Gebruik Binnen om de stal te betreden.",
		"f3d.aria.pause": "Rotatie pauzeren",
		"f3d.aria.play": "Rotatie afspelen",
		"innd.back": "← Terug naar alle innovaties",
		"innd.direct": "Directe impact",
		"innd.indirectinn": "Indirecte innovatie",
		"innd.whatitis": "Wat het is",
		"innd.howconnects": "Hoe het verbindt",
		"innd.links": "Geen innovatie staat op zichzelf. Deze is verbonden met {n} andere in het systeem.",
		"innd.requires": "Vereist",
		"innd.strengthenedby": "Versterkt door",
		"innd.impact": "Impact",
		"innd.impact.direct": "Geschat per kg levend gewicht en per jaar. Groen = een besparing, blauw = extra verbruik of lozing.",
		"innd.impact.indirect": "Dit is een indirecte innovatie — haar waarde loopt via de innovaties waarmee ze verbonden is, in plaats van een op zichzelf staand cijfer.",
		"innd.exploremap": "Verken de volledige innovatiekaart",
		"innd.footer": "Impactcijfers zijn indicatief, gebaseerd op {kg} kg levend gewicht per jaar (256.000 plaatsen × 7 rondes), en worden vervangen door gemeten data.",
		"about.cta.title": "Laten we samen iets bouwen",
		"about.cta.body": "Benieuwd hoe digital-twintechnologie uw onderzoek, producten of productie kan ondersteunen? We horen graag van u.",
	...
	de: {
		...
		"home.press.eyebrow": "In den Medien",
		"home.press.title": "Wo über unsere Arbeit berichtet wurde",
		"home.press.subtitle": "Journalisten und Fachmedien zu Besuch im Research Field — und worüber sie berichtet haben.",
		"home.press.read": "Artikel lesen",
		"home.press.prev": "Vorherige Artikel",
		"home.press.next": "Weitere Artikel",
		...
		"exp.pause": "Pause",
		"exp.spin": "Drehen",
		"exp.empty.title": "Das Netz erkunden",
		"exp.empty.body": "Drehen Sie das Netzwerk unten oder klicken Sie auf eine Markierung auf der Karte oben, um zu sehen, was eine Innovation bewirkt, wie sie sich verbindet und welche Wirkung sie hat.",
		"exp.impact.direct": "Geschätzte Wirkung — grün = Einsparung, blau = Mehrverbrauch/-ableitung",
		"exp.impact.indirect": "Indirekte Innovation — ihr Wert entfaltet sich über die Innovationen, mit denen sie verbunden ist",
		"exp.readmore": "Die ganze Geschichte lesen →",
		"exp.connectedto": "Verbunden mit:",
		"exp.howconnect": "Wie sie zusammenhängen",
		"exp.reset": "Zurücksetzen",
		"exp.every": "Jede Innovation",
		"exp.direct": "Direkte Wirkung",
		"exp.indirect": "Indirekt",
		"exp.filter.all": "Alle",
		"f3d.title": "Kuijpers-Hof · 3D-Modell",
		"f3d.outside": "Außen",
		"f3d.inside": "Innen",
		"f3d.hint": "Ziehen zum Drehen · scrollen zum Zoomen",
		"f3d.hintTouch": "Ziehen zum Drehen · zwei Finger zum Zoomen",
		"f3d.loading": "Modell wird erstellt…",
		"f3d.fullscreen": "Vollbild",
		"f3d.exit": "Schließen",
		"f3d.pause": "Pause",
		"f3d.play": "Abspielen",
		"f3d.failed": "3D konnte nicht geladen werden — Seite neu laden",
		"f3d.aria.stage": "3D-Hof. Ziehen zum Drehen, scrollen zum Zoomen. Mit Innen den Stall betreten.",
		"f3d.aria.pause": "Rotation pausieren",
		"f3d.aria.play": "Rotation abspielen",
		"innd.back": "← Zurück zu allen Innovationen",
		"innd.direct": "Direkte Wirkung",
		"innd.indirectinn": "Indirekte Innovation",
		"innd.whatitis": "Was es ist",
		"innd.howconnects": "Wie es sich verbindet",
		"innd.links": "Keine Innovation steht für sich allein. Diese ist mit {n} weiteren im System verbunden.",
		"innd.requires": "Erfordert",
		"innd.strengthenedby": "Verstärkt durch",
		"innd.impact": "Wirkung",
		"innd.impact.direct": "Geschätzt je kg Lebendgewicht und pro Jahr. Grün = eine Einsparung, blau = Mehrverbrauch oder -ableitung.",
		"innd.impact.indirect": "Dies ist eine indirekte Innovation — ihr Wert entfaltet sich über die Innovationen, mit denen sie verbunden ist, statt über eine eigenständige Zahl.",
		"innd.exploremap": "Die vollständige Innovationskarte erkunden",
		"innd.footer": "Die Wirkungszahlen sind Richtwerte, basierend auf {kg} kg Lebendgewicht pro Jahr (256.000 Plätze × 7 Durchgänge), und werden durch gemessene Daten ersetzt.",
		"about.cta.title": "Lassen Sie uns gemeinsam etwas aufbauen",
		"about.cta.body": "Neugierig, wie Digital-Twin-Technologie Ihre Forschung, Produkte oder Produktion unterstützen kann? Wir freuen uns, von Ihnen zu hören.",
	...
	fr: {
		...
		"nav.innovations": "Innovations",
		"nav.contact": "Contact",
		"footer.tagline": "Faire progresser la production avicole grâce à la technologie des jumeaux numériques et à la recherche fondée sur les données. Relier la science et la pratique pour un avenir plus durable et plus efficace.",
		"footer.navHeading": "Navigation",
		"footer.contactHeading": "Contact",
		...
		"home.hero.cta2": "Démarrer un projet",
		"home.hero.liveLabel": "En direct :",
		"home.hero.liveText": "47 variables mesurées · Mis à jour il y a 12 secondes",
		"home.mission.eyebrow": "Notre mission",
		"home.mission.title": "Transformer les données en décisions auxquelles toute la filière peut se fier.",
		"home.mission.text": "Nous faisons progresser le bien-être animal, l'efficacité de la production et la durabilité environnementale en transformant les données en temps réel de la filière avicole en connaissances validées et exploitables — des connaissances sur lesquelles producteurs, fournisseurs et décideurs peuvent s'appuyer en toute confiance.",
		...
		"home.research.eyebrow": "Recherche en vedette",
		"home.research.title": "Projets récents",
		"home.research.readMore": "Lire la suite",
		"home.partners.trusted": "Ils nous font confiance",
		"home.press.eyebrow": "Dans la presse",
		"home.press.title": "Où notre travail a été couvert",
		"home.press.subtitle": "Les journalistes et médias spécialisés qui ont visité le research field, et ce qu'ils en ont écrit.",
		"home.press.read": "Lire l'article",
		"home.press.prev": "Articles précédents",
		"home.press.next": "Plus d'articles",
		"home.innov.eyebrow": "Dernières innovations",
		"home.innov.title": "La science validée",
		"home.innov.view": "Voir l'innovation",
		"home.innov.seeAll": "Voir toutes les innovations",
		...
		"contact.hero.titleB": ".",
		"contact.hero.subtitle": "Que vous testiez une nouvelle innovation, recherchiez des preuves indépendantes ou conceviez un programme de recherche, nous aimerions savoir ce que vous cherchez à découvrir. Parlez-nous-en — et nous vous dirons si le champ de recherche peut vous aider.",
		"contact.hero.emailUs": "Écrivez-nous",
		"contact.hero.visit": "Visitez le champ de recherche",
		"contact.form.heading": "Envoyez-nous un message",
		"contact.form.sub": "Remplissez le formulaire ci-dessous et nous vous répondrons dès que possible.",
		"contact.form.reply": "Nous répondons sous deux jours ouvrés.",
		"contact.info.heading": "Coordonnées",
		"contact.info.sub": "Vous préférez nous joindre directement ? Voici comment nous trouver.",
		"contact.info.email": "E-mail",
		...
		"form.placeholder": "Comment pouvons-nous vous aider ?",
		"form.send": "Envoyer le message",
		"form.sending": "Envoi…",
		"form.err.name": "Veuillez saisir votre nom.",
		"form.err.email": "Veuillez saisir votre e-mail.",
		"form.err.emailValid": "Veuillez saisir une adresse e-mail valide.",
		"form.err.subject": "Veuillez saisir un objet.",
		"form.err.message": "Veuillez saisir un message.",
		"form.success.title": "Merci de nous avoir contactés !",
		...
		"about.story.fact3": "Partenaire de recherche indépendant",
		"about.team.eyebrow": "Nos collaborateurs",
		"about.team.title": "Rencontrez l'équipe",
		"about.team.empty": "Les profils de l'équipe arrivent bientôt — revenez sous peu.",
		...
		"svc.audience.academia": "Chercheurs et milieu universitaire",
		"svc.step.discovery.title": "Découverte",
		"svc.step.discovery.body": "Nous commençons par comprendre votre question, vos contraintes et vos critères de réussite — en définissant ce que vous voulez apprendre ou valider avant d'installer le moindre capteur.",
		"svc.step.design.title": "Conception",
		"svc.step.design.body": "Nous concevons ensemble l'essai et son jumeau numérique : logement, instrumentation, flux de données et le plan d'analyse qui produira des résultats défendables.",
		"svc.step.impl.title": "Mise en œuvre",
		"svc.step.impl.body": "Nous menons l'intervention dans notre champ de recherche instrumenté, en capturant les données en temps réel tandis que le jumeau numérique reflète les conditions tout au long du cycle.",
		"svc.step.monitor.title": "Suivi",
		"svc.step.monitor.body": "Nous suivons, validons et rapportons en continu — transformant les signaux bruts en connaissances claires et vérifiables de façon indépendante, sur lesquelles vous pouvez agir en toute confiance.",
		"svc.stat.1": "Indice de consommation réduit.",
		"svc.stat.2": "Suivi continu en temps réel.",
		"svc.stat.3": "Résultats validés de façon indépendante.",
		"svc.stat.4": "Tests d'intervention plus rapides.",
		"svc.cmp.evidence.aspect": "Preuves",
		"svc.cmp.evidence.trad": "Opinions et références venues d'ailleurs",
		"svc.cmp.evidence.kui": "Données mesurées dans un champ de recherche contrôlé",
		"svc.cmp.validation.aspect": "Validation",
		"svc.cmp.validation.trad": "Recommandations rarement testées avant le déploiement",
		"svc.cmp.validation.kui": "Interventions d'abord validées dans un jumeau numérique",
		"svc.cmp.risk.aspect": "Risque",
		"svc.cmp.risk.trad": "Essais et erreurs sur votre troupeau en activité",
		"svc.cmp.risk.kui": "Essai dans notre poulailler — votre troupeau reste protégé",
		"svc.cmp.monitoring.aspect": "Suivi",
		"svc.cmp.monitoring.trad": "Visites périodiques et instantanés",
		"svc.cmp.monitoring.kui": "Données de capteurs en continu, en temps réel 24 h/24",
		"svc.cmp.transparency.aspect": "Transparence",
		"svc.cmp.transparency.trad": "Conclusions en boîte noire",
		"svc.cmp.transparency.kui": "Méthodes ouvertes et résultats vérifiables de façon indépendante",
		"svc.cmp.speed.aspect": "Rapidité",
		"svc.cmp.speed.trad": "Des mois pour voir des résultats sur le terrain",
		"svc.cmp.speed.kui": "Des cycles plus rapides grâce aux tests numériques en parallèle",
		"svc.hero.title": "Nos services",
		"svc.hero.subA": "De la conception d'essais au suivi en temps réel, nous vous aidons à tester et valider vos interventions dans un environnement contrôlé et riche en données — en associant un champ de recherche entièrement instrumenté à un ",
		"svc.hero.subHl": "jumeau numérique",
		"svc.hero.subB": " qui le reflète en direct.",
		...
		"svc.diff.trad": "Conseil traditionnel",
		"svc.diff.ourApproach": "Notre approche",
		"svc.diff.kuijpers": "L'approche Kuijpers",
		"svc.ref.eyebrow": "Recommandations",
		"svc.ref.title": "Ce que disent nos partenaires",
		"svc.ref.quote1": "Travailler avec Kuijpers Kip Research Field nous a permis d'acquérir les connaissances nécessaires pour passer à une production avicole sans émissions.",
		"svc.ref.quote2": "La vision et la capacité de mise en œuvre font toute la différence.",
		...
		"res.hero.bodyHl": "connaissances validées",
		"res.hero.bodyB": " auxquelles toute la filière peut se fier. Parcourez ci-dessous nos projets en cours, achevés et planifiés.",
		"res.intro.eyebrow": "Nos travaux",
		"res.intro.titleA": "Les projets derrière la ",
		"res.intro.titleHl": "preuve",
		"res.intro.titleB": ".",
		"res.intro.body": "Chaque affirmation que nous faisons sur la production avicole s'appuie sur un projet de recherche concret — en cours, achevé ou en conception. Parcourez les travaux qui façonnent les normes de bien-être, les objectifs d'émissions et les références d'efficacité dans tout le secteur.",
		"res.status.ongoing": "En cours",
		"res.status.completed": "Achevé",
		"res.status.planned": "Planifié",
		"res.stat.inDesign": "En conception",
		"res.filter.all": "Tous",
		"res.card.teamOne": "membre de l'équipe",
		"res.card.teamMany": "membres de l'équipe",
		"res.card.view": "Voir le projet",
		"res.filter.empty": "Aucun projet ne correspond encore à ce filtre — revenez bientôt.",
		"res.empty": "Les projets de recherche arrivent bientôt — revenez sous peu.",
		"res.cta.title": "Vous avez une question de recherche ?",
		"res.cta.body": "Dites-nous ce que vous voulez apprendre ou valider, et nous vous montrerons comment notre champ de recherche et notre jumeau numérique peuvent vous y mener.",
		"res.cta.button": "Contactez-nous",
		"res.detail.crumb": "Recherche",
		"res.detail.overviewSoon": "Un aperçu de ce projet arrive bientôt.",
		...
		"exp.pause": "Pause",
		"exp.spin": "Tourner",
		"exp.empty.title": "Explorez le réseau",
		"exp.empty.body": "Faites tourner le réseau ci-dessous, ou cliquez sur un repère de la carte ci-dessus, pour voir ce que fait une innovation, comment elle se connecte et quel est son impact.",
		"exp.impact.direct": "Impact estimé — vert = économie, bleu = usage/rejet supplémentaire",
		"exp.impact.indirect": "Innovation indirecte — sa valeur passe par les innovations auxquelles elle est reliée",
		"exp.readmore": "Lire l'histoire complète →",
		"exp.connectedto": "Connectée à :",
		"exp.howconnect": "Comment elles se connectent",
		"exp.reset": "Réinitialiser",
		"exp.every": "Chaque innovation",
		"exp.direct": "Impact direct",
		"exp.indirect": "Indirect",
		"exp.filter.all": "Toutes",
		"f3d.title": "Ferme Kuijpers · modèle 3D",
		"f3d.outside": "Extérieur",
		"f3d.inside": "Intérieur",
		"f3d.hint": "Faites glisser pour pivoter · molette pour zoomer",
		"f3d.hintTouch": "Faites glisser pour pivoter · pincez pour zoomer",
		"f3d.loading": "Construction du modèle…",
		"f3d.fullscreen": "Plein écran",
		"f3d.exit": "Quitter",
		"f3d.pause": "Pause",
		"f3d.play": "Lecture",
		"f3d.failed": "Échec du chargement de la 3D — actualisez la page",
		"f3d.aria.stage": "Ferme 3D. Faites glisser pour pivoter, molette pour zoomer. Utilisez Intérieur pour entrer dans le poulailler.",
		"f3d.aria.pause": "Mettre la rotation en pause",
		"f3d.aria.play": "Lancer la rotation",
		"innd.back": "← Retour à toutes les innovations",
		"innd.direct": "Impact direct",
		"innd.indirectinn": "Innovation indirecte",
		"innd.whatitis": "Ce que c'est",
		"innd.howconnects": "Comment elle se connecte",
		"innd.links": "Aucune innovation n'existe seule. Celle-ci est reliée à {n} autres dans le système.",
		"innd.requires": "Nécessite",
		"innd.strengthenedby": "Renforcée par",
		"innd.impact": "Impact",
		"innd.impact.direct": "Estimé par kg de poids vif et par an. Vert = une économie, bleu = usage ou rejet supplémentaire.",
		"innd.impact.indirect": "Il s'agit d'une innovation indirecte — sa valeur passe par les innovations auxquelles elle est reliée, plutôt que par un chiffre autonome.",
		"innd.exploremap": "Explorer la carte complète des innovations",
		"innd.footer": "Les chiffres d'impact sont indicatifs, basés sur {kg} kg de poids vif par an (256 000 places × 7 cycles), et seront remplacés par des données mesurées.",
		"about.cta.title": "Construisons quelque chose ensemble",
		"about.cta.body": "Curieux de savoir comment la technologie des jumeaux numériques pourrait soutenir votre recherche, vos produits ou votre production ? Nous serions ravis d'avoir de vos nouvelles.",
		"about.cta.button": "Contactez-nous",
		"inn.explore.eyebrow": "Explorez le site",
		"inn.explore.title": "De l'extérieur à l'intérieur",
		"inn.explore.subtitle": "Le modèle tourne de lui-même — passez à l'intérieur pour voir les poulaillers, les animaux et les rangées, et jusqu'où la ferme a été menée.",
		"inn.section.eyebrow": "Interconnectées",
		"inn.section.title": "Une vision, pas une liste",
		"inn.section.subtitle": "Nos innovations ne fonctionnent pas isolément — chacune soutient et renforce les autres. Faites tourner le réseau pour voir comment elles se relient, puis ouvrez-en une pour son histoire complète et son impact réel sur le CO₂, l'ammoniac, l'énergie, l'eau et les nutriments.",
	},
} as const;
